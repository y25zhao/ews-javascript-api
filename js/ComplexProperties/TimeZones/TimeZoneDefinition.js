...
var TimeZoneDefinition = /** @class */ (function (_super) {
    ...
    function TimeZoneDefinition(timezoneInfo) {
        ...
        _this.Name = "UTC"; //check:utc by default
        _this.Id = "UTC"; //check:utc by default
        //private name: string; backing property not needed
        //private id: string;
        _this.periods = new AltDictionary_1.DictionaryWithStringKey(); // System.Collections.Generic.Dictionary<string, TimeZonePeriod>;
        _this.transitionGroups = new AltDictionary_1.DictionaryWithStringKey(); // System.Collections.Generic.Dictionary<string, TimeZoneTransitionGroup>;
        _this.transitions = []; //System.Collections.Generic.List<TimeZoneTransition>;
